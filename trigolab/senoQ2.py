...
class SenoQ2(Scene):  
   ...
   #CRIAR NOVOS PONTOS DIFERENTES NO GRÁFICO E A RESPOSTA CERTA VAI SER A LETRA C
    ...
    def construct(self):
        ...
        pontoA=Dot(axes_graph.c2p(np.pi/6,sin(np.pi/6)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        pontoB=Dot(axes_graph.c2p(np.pi/3,sin(np.pi/3)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        pontoC=Dot(axes_graph.c2p(2/3*np.pi,sin(2/3*np.pi)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        pontoD=Dot(axes_graph.c2p(7*np.pi/6,sin(7*np.pi/6)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelAngle=MathTex("\\frac{2\pi}{3}", 
                       color=WHITE,
        ...
        self.play(Write(label_graph0),Write(label_circulo0),run_time=0.5)

        self.play(Write(label_graphpi2),Write(label_circulopi2),run_time=0.5)
        self.play(Write(label_graphpi),Write(label_circulopi),run_time=0.5)
        self.play(Write(label_graph3pi2),Write(label_circulo3pi2),run_time=0.5)
