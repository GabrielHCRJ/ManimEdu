...
class CosQ4(Scene):  
    ...
    def construct(self):
        ...
        pontoB=Dot(axes_graph.c2p(np.pi,cos(np.pi)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelB=MathTex("B", 
                       ...
                       font_size=24).next_to(pontoB,
                                             0.25*UP + 0.25*RIGHT,
                                             buff=0.2)
        pontoC=Dot(axes_graph.c2p(5*np.pi/3,cos(5*np.pi/3)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelC=MathTex("C", 
                       ...
                       font_size=24).next_to(pontoC,
                                             UP + LEFT,
                                             buff=0.2)
        pontoD=Dot(axes_graph.c2p(2*np.pi,cos(2*np.pi)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        respostas('C=(\\frac{5\\pi}{3},cos(\\frac{5\\pi}{3}))',pontoC,5*pi/3)        
