...
class CosQ1(Scene):  
    ...
    def construct(self):
        ...
        pontoA=Dot(axes_graph.c2p(np.pi/3,cos(np.pi/3)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelD=MathTex("D", 
                       ...
                       font_size=24).next_to(pontoD,
                                             DOWN + RIGHT,
                                             buff=0.2)
        pontoB=Dot(axes_graph.c2p(np.pi/2,cos(np.pi/2)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelB=MathTex("B", 
                       ...
                       font_size=24).next_to(pontoB,
                                             0.25*UP + 0.25*RIGHT,
                                             buff=0.2)
        pontoC=Dot(axes_graph.c2p(np.pi,cos(np.pi)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
