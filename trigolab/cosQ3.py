...
class CosQ3(Scene):  
    ...
    def construct(self):
        ...
        pontoA=Dot(axes_graph.c2p(0,cos(0)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        pontoB=Dot(axes_graph.c2p(np.pi/3,cos(np.pi/3)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelB=MathTex("B", 
                       ...
                       font_size=24).next_to(pontoB,
                                             0.25*UP + 0.25*RIGHT,
                                             buff=0.2)
        pontoC=Dot(axes_graph.c2p(2*np.pi/3,cos(2*np.pi/3)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelC=MathTex("C", 
                       ...
                       font_size=24).next_to(pontoC,
                                             UP + RIGHT,
                                             buff=0.2)
        pontoD=Dot(axes_graph.c2p(5*np.pi/4,cos(5*np.pi/4)),
                   color=RED,
                   fill_opacity=5,
                   stroke_width=1)
        ...
        labelAngle=MathTex("\\frac{5\pi}{4}", 
                       color=WHITE,
        ...
        self.play(Create(curva_parametrica2),Create(cosseno),run_time=3)
        ...
        respostas('D=(\\frac{5\\pi}{4},cos(\\frac{5\\pi}{4}))',pontoB,5*pi/4)  
